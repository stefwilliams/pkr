...
<div class="em-warning em-warning-confirms">
<?php
	if (($_REQUEST['success'] == 1) && ($_REQUEST['action'] == 'edit')) {
...
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>">
	...
	<div class="wrap">
		...
		<h3 class="event-form-name"><?php esc_html_e( 'Game Title', 'dbem' ); ?></h3>
		...
		<div class="inside event-form-details">
			...
			<div class="event-editor">
				...
				<?php else: ?>
					...
					<?php esc_html_e( 'Details about the game.', 'dbem' )?> <?php esc_html_e( 'HTML allowed.', 'dbem' )?>
		...
		<h3><?php esc_html_e( 'Game Image', 'dbem' ); ?></h3>

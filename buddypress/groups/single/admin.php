...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<label for="group-name"><?php _e( 'League Name (required)', 'buddypress' ); ?></label>
	<input type="text" name="group-name" id="group-name" value="<?php bp_group_name(); ?>" aria-required="true" />

	<label for="group-desc"><?php _e( 'League Description (required)', 'buddypress' ); ?></label>
	...
	<p>
		<label for="group-notifiy-members">
			<input type="checkbox" name="group-notify-members" value="1" /> <?php _e( 'Notify league members of these changes via email', 'buddypress' ); ?>
		</label>
	</p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<div class="radio">
		<label>
			...
			<strong><?php _e( 'This is a public league', 'buddypress' ); ?></strong>
			<ul>
				<li><?php _e( 'Any site member can join this league.', 'buddypress' ); ?></li>
				<li><?php _e( 'This league will be listed in the leagues directory and in search results.', 'buddypress' ); ?></li>
				<li><?php _e( 'League content and activity will be visible to any site member.', 'buddypress' ); ?></li>
			</ul>
		</label>

		<label>
			<input type="radio" name="group-status" value="private"<?php bp_group_show_status_setting( 'private' ); ?> />
			<strong><?php _e( 'This is a private league', 'buddypress' ); ?></strong>
			<ul>
				<li><?php _e( 'Only users who request membership and are accepted can join the league.', 'buddypress' ); ?></li>
				<li><?php _e( 'This league will be listed in the leagues directory and in search results.', 'buddypress' ); ?></li>
				<li><?php _e( 'League content and activity will only be visible to members of the league.', 'buddypress' ); ?></li>
			</ul>
		</label>

		<label>
			<input type="radio" name="group-status" value="hidden"<?php bp_group_show_status_setting( 'hidden' ); ?> />
			<strong><?php _e( 'This is a hidden league', 'buddypress' ); ?></strong>
			<ul>
				<li><?php _e( 'Only users who are invited can join the league.', 'buddypress' ); ?></li>
				<li><?php _e( 'This league will not be listed in the leagues directory or search results.', 'buddypress' ); ?></li>
				<li><?php _e( 'League content and activity will only be visible to members of the league.', 'buddypress' ); ?></li>
			</ul>
		</label>
	</div>
	...
	<h4><?php _e( 'League Invitations', 'buddypress' ); ?></h4>

	<p><?php _e( 'Which members of this league are allowed to invite others?', 'buddypress' ); ?></p>

	<div class="radio">
		<label>
			<input type="radio" name="group-invite-status" value="members"<?php bp_group_show_invite_status_setting( 'members' ); ?> />
			<strong><?php _e( 'All league players', 'buddypress' ); ?></strong>
		</label>

		<label>
			<input type="radio" name="group-invite-status" value="mods"<?php bp_group_show_invite_status_setting( 'mods' ); ?> />
			<strong><?php _e( 'League admins and mods only', 'buddypress' ); ?></strong>
		</label>

		<label>
			<input type="radio" name="group-invite-status" value="admins"<?php bp_group_show_invite_status_setting( 'admins' ); ?> />
			<strong><?php _e( 'League admins only', 'buddypress' ); ?></strong>
		</label>
 	</div>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p><?php _e("Upload an image to use as a profile photo for this league. The image will be shown on the main league page, and in search results.", 'buddypress' ); ?></p>
			...
			<?php if ( bp_get_group_has_avatar() ) : ?>
				...
				<p><?php _e( "If you'd like to remove the existing league profile photo but not upload a new one, please use the delete league profile photo button.", 'buddypress' ); ?></p>

				<?php bp_button( array( 'id' => 'delete_group_avatar', 'component' => 'groups', 'wrapper_id' => 'delete-group-avatar-button', 'link_class' => 'edit', 'link_href' => bp_get_group_avatar_delete_link(), 'link_title' => __( 'Delete League Profile Photo', 'buddypress' ), 'link_text' => __( 'Delete League Profile Photo', 'buddypress' ) ) ); ?>
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div class="submit">
		<input type="submit" disabled="disabled" value="<?php esc_attr_e( 'Delete League', 'buddypress' ); ?>" id="delete-group-button" name="delete-group-button" />
	</div>
